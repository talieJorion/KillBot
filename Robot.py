...
class Robot(object):
    def __init__(self, addr=0x60, left_front_id=1, right_front_id=2, left_back_id=4, right_back_id=3, left_trim=0, right_trim=0,
                 stop_at_exit=True):
        """Create an instance of the robot.  Can specify the following optional
        parameters:
         - addr: The I2C address of the motor HAT, default is 0x60.
         - left_front_id: The ID of the left motor, default is 1.
         - right_front_id: The ID of the right motor, default is 2.
        ...
        self._left_back = self._mh.getMotor(left_back_id)
        self._right_back = self._mh.getMotor(right_back_id)
        ...
        self._left_back.run(Adafruit_MotorHAT.RELEASE)
        self._right_back.run(Adafruit_MotorHAT.RELEASE)
    ...
    def _left_speed(self, speed):
        ...
        self._left_back.setSpeed(speed)
    ...
    def _right_speed(self, speed):
        ...
        self._right_back.setSpeed(speed)
    ...
    def right(self, speed, seconds=None):
        ...
        self._left_front.run(Adafruit_MotorHAT.FORWARD)
        self._leftt_back.run(Adafruit_MotorHAT.FORWARD)
